...
public class DataBaseHandler extends SQLiteOpenHelper {
	...
	Contacto getContact(int id) {
		...
		Cursor cursor = db.query(TABLE_CONTACTS, new String[] { KEY_ID, KEY_IMAGE }, KEY_ID + "=?", new String[] { String.valueOf(id) }, null, null, null, null);
		if (cursor != null)
			cursor.moveToFirst();

		Contacto contact = new Contacto(Integer.parseInt(cursor.getString(0)), cursor.getBlob(1));
